...
public class ProjectsApp {
  ...
  /**
   * This method allows the user to update project details for the currently selected project.
   */
  ...
  /**
   * This method allows the user to delete the currently selected project.
   */
