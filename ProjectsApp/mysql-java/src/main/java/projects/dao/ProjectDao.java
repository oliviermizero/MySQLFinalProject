...
public class ProjectDao extends DaoBase {
  ...
  /**
   * This method updates project details in the project table.
   * 
   * @param project The project object with updated details.
   * @return true if the project was updated successfully, false if the project ID is invalid.
  ...
  /**
   * This method deletes a project from the project table. The foreign key constraints with ON DELETE CASCADE
   * will automatically delete all related materials, steps, and project_category rows.
   * 
   * @param projectId The ID of the project to delete.
   * @return true if the project was deleted successfully, false if the project ID is invalid.
